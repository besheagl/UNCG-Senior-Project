...
#myMenu li a:hover {
  background-color: #eee;
    ...
    <main>
    <span class="listtitle"><h3>Shows</h3></span>
...
<?php for ($i = 0; $i < count($list); $i++){	//builds a list of all show names with links to show.php ?>
  <li> 
      <a href = "<?php echo "https://armchair.000webhostapp.com/show.php/?showID=" . getShowInfo($con, $list[$i])[0]; ?>"><?php echo getShowInfo($con, $list[$i])[1]; ?></a>
  </li>
<?php } ?>
</form>
</ul>
