			...
			<li class="comment-with-replies">
				<div class="data" style = 'display: block;'>
					<span class = "subdata" style = 'display: float; float:top; width: 100%;'>
						<a href="https://armchair.000webhostapp.com/profileshows.php/?dispusername=<?php echo $defaultfields[3]; ?>">
				...
				<!--REPLY TO SPECIFIC COMMENT WITH REPLY BUTTON-->
					<input type="submit" name="replybutton" class="like" value="Reply" id="reply"/>
					<!--THIS DIV APPEARS WHEN REPLY BUTTON IS CLICKED-->
					<div id="message">
                      <div id = 'addstuff'>
	                	<?php if ($username) { ?>
                           <form method="post" action="https://armchair.000webhostapp.com/postep.php">
                               <fieldset><legend>Comment</legend>
				            	<select name = 'replyTo' style = 'width: 90%; height: 50px;'>
					         	<?php  
							    	echo "<option value = ".$defaultfields[0].">Reply to comment #".$defaultfields[0]."</option>";
					        	 ?>
					            </select>
				...
				<ol class="medialist">
					<?php foreach ($replies as $retval2=>$info) { ?>
						...
						<li class="reply">
							<div class="data">
								<a href="https://armchair.000webhostapp.com/profileshows.php/?dispusername=<?php echo $info[2]; ?>">
